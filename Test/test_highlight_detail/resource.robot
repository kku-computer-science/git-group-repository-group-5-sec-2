...
${BROWSER}           Chrome
${HIGHLIGHT_DETAIL_URL}        ${SERVER}/highlightdetail/12
...
${GALLERY_IMAGE}               xpath=(//img[contains(@class, 'image')])[1]
...
Click Gallery Image And Verify Modal
    ...
    Sleep    3s
    Wait Until Element Is Visible    ${IMAGE_MODAL}    timeout=5s
    Element Should Be Visible    ${IMAGE_MODAL}
